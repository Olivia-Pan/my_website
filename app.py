...
with tab2:
    ...
    **Snippai** — *Marketing Intern*,  
    ...
    - Created and managed company's Discord community page, regulating discussions, engaging users, and maintainingc a positive and organized online environment to support community growth
